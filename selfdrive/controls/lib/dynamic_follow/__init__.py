...
class DynamicFollow:
  ...
  def _get_TR(self):
    ...
    if df_profile == PROFILE_LONG:
      y_dist = [1.2381, 1.3481, 1.3791, 1.4143, 1.4499, 1.4900, 1.5330, 1.5774, 1.7495, 1.8940, 1.9343, 1.9710, 2.0498]  # TRs
      profile_mod_pos = [0.5, 0.8, 0.1, 0.03]
      ...
      y_dist = [1.2381, 1.2881, 1.3165, 1.3260, 1.3260, 1.3165, 1.3026, 1.2754, 1.2277, 1.1751, 1.155, 1.15]
      profile_mod_pos = [1.05, 1.3, 1.35, 1.25]
      profile_mod_neg = [1.15, 1.0, 0.85, 0.75]
    elif df_profile == PROFILE_NORMAL:  # default to relaxed/stock
      y_dist = [1.2381, 1.3194, 1.3406, 1.3778, 1.4083, 1.4354, 1.4578, 1.4757, 1.5269, 1.5683, 1.5791, 1.5939, 1.6140]
      profile_mod_pos = [0.8, 1.0, 0.85, 0.7]
      profile_mod_neg = [1.05, 0.925, 0.96, 0.93]
    else:
