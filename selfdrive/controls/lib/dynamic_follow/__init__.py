...
class DynamicFollow:
  ...
  def _get_TR(self):
    ...
    if df_profile == PROFILE_LONG:
      y_dist = [1.2381, 1.3781, 1.3791, 1.3843, 1.4307, 1.4737, 1.5330, 1.5774, 1.7495, 1.8940, 1.9343, 1.9710, 2.0498]  # TRs
      profile_mod_pos = [0.7, 0.8, 0.6, 0.5]
      ...
      y_dist = [1.2381, 1.2611, 1.2915, 1.3102, 1.3183, 1.3065, 1.2754, 1.2277, 1.1441, 1.0238, 1.0, 1.0156]
      profile_mod_pos = [1.2, 1.2, 1.35, 1.25]
      profile_mod_neg = [1.2, 1.15, 0.75, 0.65]
