...
class DynamicFollow:
  ...
  def _get_TR(self):
    ...
    if df_profile == PROFILE_LONG:
      y_dist = [1.2381, 1.3046, 1.3378, 1.3843, 1.4307, 1.4737, 1.5330, 1.5774, 1.7495, 1.8940, 1.9343, 1.9710, 2.0498]  # TRs
      profile_mod_pos = [0.85, 0.9025, 0.65, 0.55]
      profile_mod_neg = [1.3, 1.3, 1.05, 1.15]
      ...
      y_dist = [1.2381, 1.2691, 1.2815, 1.3045, 1.3183, 1.3065, 1.2754, 1.2277, 1.1441, 1.0238, 0.9461, 0.9156]
      profile_mod_pos = [0.85, 1.25, 1.05, 1.0]
      profile_mod_neg = [1.7, 1.5, 0.85, 0.75]
      ...
      profile_mod_pos = [0.9, 1.4, 1.5, 1.7]
      profile_mod_neg = [1.05, 1.0, 0.95, 0.9]
    else:
