...
class DynamicFollow:
  ...
  def _get_TR(self):
    ...
    if df_profile == PROFILE_LONG:
      y_dist = [1.2381, 1.3056, 1.3378, 1.3843, 1.4307, 1.4737, 1.5330, 1.5774, 1.7495, 1.8940, 1.9343, 1.9710, 2.0498]  # TRs
      profile_mod_pos = [0.8888, 0.9025, 0.65, 0.55]
      ...
      y_dist = [1.2381, 1.2711, 1.2815, 1.3045, 1.3183, 1.3065, 1.2754, 1.2277, 1.1441, 1.0238, 0.9461, 0.9156]
      profile_mod_pos = [0.65, 1.2, 1.1, 1.05]
      ...
      profile_mod_pos = [0.75, 0.95, 0.55, 0.6]
