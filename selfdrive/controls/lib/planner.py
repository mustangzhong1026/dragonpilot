...
_AP_CRUISE_MIN_V_SPORT = [-2.0, -2.6, -2.3, -2.0, -1.0]
_AP_CRUISE_MIN_V_FOLLOWING = [-2.0, -4.0, -3.5, -2.5, -2.0]
_AP_CRUISE_MIN_BP = [0.0, 5.0, 10.0, 20.0, 55.0]

_AP_CRUISE_MAX_V = [1.95, 1.245, 0.88, 0.39, 0.205]
_AP_CRUISE_MAX_V_ECO = [1.75, 1.0, 0.695, 0.29, 0.09]
_AP_CRUISE_MAX_V_SPORT = [3.5, 3.25, 3.0, 2.75, 2.5]
_AP_CRUISE_MAX_V_FOLLOWING = [1.95, 1.35, 0.88, 0.39, 0.1]
