...
_DP_CRUISE_MAX_V = [1.95, 1.1, 0.8, 0.35, 0.205]
_DP_CRUISE_MAX_V_ECO = [1.6, 0.95, 0.71, 0.29, 0.088]
_DP_CRUISE_MAX_V_SPORT = [2.5, 1.8, 1.1, 0.7, 0.4]
_DP_CRUISE_MAX_V_FOLLOWING = [2.0, 1.2, 0.8, 0.31, 0.1]
_DP_CRUISE_MAX_BP = [0., 5., 10., 20., 55.]

# Lookup table for turns
_DP_TOTAL_MAX_V = [1.3, 1.0, 1.9]
